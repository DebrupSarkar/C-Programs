...
/*DEBRUP SARKAR,ROLL NUMBER=54,case
  ASSIGNMENT 6
  Q1>WRITE A MENU DRIVEN PROGRAM TO IMPLEMENT:
     i>CREATE A list
     ii>DELETE AT THE FRONT OF THE list
     iii>DELETE AT THE END OF THE list
     iv>SEARCH FOR THE KEY Element
     v>DELETE ELEMENT BEFORE THE KEY ELEMENT
     vi>DELETE ELEMENT AFTER THE KEY ELEMENT
